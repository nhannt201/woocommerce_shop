		...
		<article id="content" class="clearfix"<?php barter_schema_args('creative'); ?>>
			<div class="content-limiter">
				<div id="col-mask">
					...
					if( $sticky_one_page ){
						echo ' data-a13-sticky-one-page-icon-global-color="' . esc_attr( $barter_a13->barter_get_meta( '_content_sticky_one_page_bullet_color' ) ) . '"';
						echo ' data-a13-sticky-one-page-icon-global-icon="' . esc_attr( $barter_a13->barter_get_meta( '_content_sticky_one_page_bullet_icon' ) ) . '"';
					}
					?>>
						<div class="formatter">
